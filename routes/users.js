...
router.use('/chatBox', require('./chat_Box.js'));
...
router.post('/addFollower/:id',usersController.addFollower);
router.get('/removeFollower/:id',usersController.removeFollower);
